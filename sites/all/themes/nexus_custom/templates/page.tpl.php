...
<div id="page">
  ...
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','nexus_custom')): ?>
  <?php
    $slide1_head = check_plain(theme_get_setting('slide1_head','nexus_custom'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','nexus_custom'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','nexus_custom'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','nexus_custom'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','nexus_custom'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','nexus_custom'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','nexus_custom'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','nexus_custom'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','nexus_custom'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus_custom') . '/images/slide-image-1.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus_custom') . '/images/slide-image-2.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus_custom') . '/images/slide-image-3.jpg'; ?>"/>
